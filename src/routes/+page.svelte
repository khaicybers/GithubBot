...
<div class="container mx-auto p-4 max-w-md">
	...
	<div class="mt-8 text-center text-sm text-gray-500">
		...
		<p>
			Poke <a class="text-blue-500" target="_blank" href="https://x.com/KhaineeeD84692">Admin</a> if something
			goes wrong
		</p>
		<p>
			<a class="text-blue-500" target="_blank" href="https://github.com/khaicybers/github-roast"
